(function () {
  ...
  const en = {
    ...
    text: {
      ...
      ".mission-points article:nth-child(1) h3": "Sought help, but nothing changed",
      ".mission-points article:nth-child(2) h3": "Are not ready or able to ask for support",
      ".mission-points article:nth-child(3) h3": "Dream of escaping to the forest and working with their hands",
      ".mission-accent": "MROJA is a place of strength and recovery for those who need it most",
    ...
    stages: [
      ["Site preparation", "Clear the area, remove waste, level the ground and sow grass"],
      ["Utilities", "Water, sewage, electricity and basic conditions"],
      ["Places to stay", "Tent area, summer cabins and basic comfort for guests and volunteers"],
      ["House restoration", "Strengthen the structure, walls, roof and interior space"],
      ["Utility block", "Separate building with showers, toilets and storage space"],
      ["Further development", "Infrastructure, retreats, workshops and the quest app"],
    ],
  };
