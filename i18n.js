(function () {
  ...
  const en = {
    ...
    text: {
      ...
      "#hero-title": "Reviving an abandoned homestead in the forest",
      ...
      ".renewal-card:nth-child(1) h3": "Working with your hands",
      ".renewal-card:nth-child(1) p": "Clears the mind",
      ".renewal-card:nth-child(2) h3": "Nature",
      ".renewal-card:nth-child(2) p": "Lowers stress",
      ".renewal-card:nth-child(3) h3": "Taking part in restoration",
      ".renewal-card:nth-child(3) p": "Fills life with meaning",
      ".renewal-card:nth-child(4) h3": "Visible result",
      ".renewal-card:nth-child(4) p": "Gives a sense of strength",
      ".renewal-card:nth-child(5) h3": "People nearby",
      ".renewal-card:nth-child(5) p": "Create connection",
